...
/**
 * The primary key class for the HU_EMPLS_MEX database table.
 * 
 */
@Embeddable
public class HuEmplsMexPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof HuEmplsMexPK)) {
			return false;
		}
		HuEmplsMexPK castOther = (HuEmplsMexPK)other;
		return 
